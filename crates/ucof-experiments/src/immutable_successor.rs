...
#[cfg(test)]
include!("immutable_successor/bounded_page_ref_stage_candidate.rs");
#[cfg(test)]
include!("immutable_successor/bounded_end_to_end_candidate.rs");
...
mod source_api {
    ...
    mod async_source_lookup_api {
        use super::*;

        include!("immutable_successor/conditional_async_source_lookup.rs");
    }
    ...
    mod async_source_full_api {
        ...
        include!("immutable_successor/conditional_async_source_recovery.rs");
    }
