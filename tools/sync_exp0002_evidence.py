#!/usr/bin/env python3
"""One-time synchronization of concrete EXP-0002 evidence into primary docs."""

from pathlib import Path


def update_status() -> None:
    path = Path("docs/PHASE_3_STATUS.md")
...
def update_threat_model() -> None:
    path = Path("docs/THREAT_MODEL.md")
    text = path.read_text(encoding="utf-8")
