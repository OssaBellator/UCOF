#!/usr/bin/env python3
"""Idempotently fold executable EXP-0001 findings into the primary threat model."""

from pathlib import Path

MARKER = "## 16. Executable findings from UCOF-EXP-0001"
SECTION = r"""
...
def main() -> None:
    ...
    if MARKER in text:
        print("EXP-0001 findings are already integrated")
        return
    path.write_text(text.rstrip() + SECTION + "\n", encoding="utf-8")
    print("integrated EXP-0001 findings")
