...
| [0004 — CBOR interoperability](0004-cbor-interoperability.md) | Do restricted UCOF metadata encodings match an established CBOR implementation? | `cargo test -p ucof-core --test cbor_interop` |
